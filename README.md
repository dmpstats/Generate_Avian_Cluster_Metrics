...
| `pnts_spread_area`                                                                                                  | The spread area of location points comprised by the cluster (units: m^2)                                                                                                              | The area of the polygon created from the convex hull of points in the cluster (calculated via [`sf::st_convex_hull`](https://r-spatial.github.io/sf/reference/geos_unary.html)). |
