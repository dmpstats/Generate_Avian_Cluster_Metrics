...
| `first_dttm`                                                                                | Timestamp of the first track point in the cluster (units: UTC)                                                                                                                                                                          | Find the track’s earliest recorded locations in the cluster                                                                                                                                                                                                                              |
| `last_dttm`                                                                                 | Timestamp of the last track point in the cluster (units: UTC)                                                                                                                                                                           | Find the track’s latest recorded locations in the cluster                                                                                                                                                                                                                                |
...
| `timespan_ndays`                                                                            | Total number of integer days over which the track visits the cluster, including lags during which the track is absent from the cluster                                                                                                  | The length of the sequence between the date components of `first_dttm` and `last_dttm`                                                                                                                                                                                                   |
...
| Attribute Name                                                                                                  | Description                                                                                                                                                                       | Calculation                                                                                                                                                                      |
|:----------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `spawn_dttm`                                                                                                    | The ‘spawning’ date-time of the cluster event (units: UTC)                                                                                                                        | The earliest timestamp of all point locations associated with the cluster.                                                                                                       |
| `cease_dttm`                                                                                                    | The ‘ending’ date-time of the cluster event (units: UTC)                                                                                                                          | The latest timestamp of all point locations associated with the cluster.                                                                                                         |
...
| `timespan_ndays`                                                                                                | Total number of integer days covered by the cluster event, including days without visiting tracks                                                                                 | The length of the sequence between the date components of `cease_dttm` and `spawn_dttm`                                                                                          |
