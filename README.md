...
| `mean_attendance_daytime`                                                                               | The track’s daily mean attendance time at the cluster during daytime, i.e. the period between sunset and sunrise (unit: hours)                                                                                                          | Identical to `mean_attendance`, but including only location events where `nightpoint == 0`                                                                                                                                                                    |
